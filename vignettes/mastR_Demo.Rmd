...
As markers and row names of `bg_mat` are gene SYMBOLs while `sig_mat` has ENSEMBL IDs as row names, 

mastR provides the gene ID conversion feature in most of the in-built functions by param `gene_id` to meet the mis-matched ID types of markers and input data.
